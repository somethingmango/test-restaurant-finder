      ...
      items: [
        {
          ...
          protein: 12,
          description:
            'Classic hamburger with beef patty, pickles, onions, ketchup, and mustard.',
        ...
        },
        {
          ...
          customization:
            'Good protein for the calories compared with larger burgers.',
        ...
        },
        {
          ...
          protein: 48,
          description:
            'Two quarter-pound beef patties with cheese and classic toppings.',
          customization: 'Very strong protein, but higher calorie.',
          tags: ['burger', 'has cheese', 'highest protein'],
          source: 'McDonald’s official nutrition calculator',
        },
        {
          name: 'Big Mac',
          ...
          protein: 25,
          description:
            'Two beef patties, special sauce, lettuce, cheese, pickles, onions, and sesame bun.',
          customization:
            'Not the best protein score, but useful for comparison.',
        ...
        },
        {
          ...
          customization:
            'Higher protein than McChicken. Skip fries or sugary drinks.',
          tags: ['chicken', 'sandwich'],
          source: 'McDonald’s official nutrition calculator',
        },
        {
          ...
          protein: 27,
          description:
            'McCrispy with lettuce, tomato, and mayo-style sauce.',
          customization: 'Ask for light/no mayo-style sauce if available.',
          tags: ['chicken', 'sandwich'],
          source: 'McDonald’s official nutrition calculator',
        },
        {
          ...
          customization: 'Good protein, but sauce adds calories.',
        ...
        },
        {
          ...
          customization: 'Good small snack, but not a full high-protein meal.',
        ...
        },
        {
          ...
          customization:
            'High protein, but calorie-dense and easy to overdo with sauces.',
          tags: ['chicken', 'nuggets', 'high protein', 'high calorie'],
          source: 'McDonald’s official nutrition calculator',
        },
        {
          name: 'Egg McMuffin',
        ...
        },
        {
          ...
          protein: 13,
          description:
            'Breakfast burrito with sausage, egg, cheese, and vegetables.',
          customization: 'Lower calorie breakfast option, but moderate protein.',
          tags: ['breakfast', 'burrito', 'has cheese'],
          source: 'McDonald’s official nutrition calculator',
        },
        {
        ...
        },
        {
          ...
          calories: 460,
          protein: 17,
          description: 'Bacon, egg, and cheese on a biscuit.',
          customization:
            'Biscuit makes this more calorie-dense than McMuffin options.',
        ...
        },
        {
          ...
          protein: 20,
          description:
            'Sausage, egg, and cheese between sweet McGriddle cakes.',
          customization: 'Higher sugar/calorie breakfast item.',
          tags: ['breakfast', 'has cheese', 'filling'],
          source: 'McDonald’s official nutrition calculator',
        },
      ],
      ...
      items: [
        {
          ...
          protein: 13,
          description:
            'Small flame-grilled beef burger with pickles, ketchup, and mustard.',
          customization: 'Simple lower-calorie burger option.',
          tags: ['burger', 'lower calorie'],
        ...
        },
        {
          ...
          protein: 16,
          description:
            'Smaller Whopper-style burger with lettuce, tomato, pickles, onion, mayo, and ketchup.',
        ...
        },
        {
          ...
          customization:
            'Lower protein than double cheeseburger, but moderate calories.',
          tags: ['burger'],
          source: 'Burger King nutrition data / published nutrition references',
        },
        {
          ...
          protein: 32,
          description:
            'Flame-grilled Whopper with lettuce, tomato, pickles, onion, ketchup, and mayo.',
        ...
        },
        {
          ...
          tags: ['burger', 'highest protein', 'high calorie'],
          source: 'Burger King nutrition data / published nutrition references',
        },
        {
          ...
          calories: 1060,
          protein: 56,
          description: 'Double Whopper with cheese.',
          customization: 'Very high protein, but calorie-dense.',
          tags: ['burger', 'has cheese', 'highest protein', 'high calorie'],
          source: 'Burger King nutrition data / published nutrition references',
        },
        {
          name: 'Bacon King',
          ...
          customization:
            'Very calorie-dense. Consider splitting or skipping sides.',
          tags: ['burger', 'has cheese', 'highest protein', 'high calorie'],
          source: 'Burger King nutrition data / published nutrition references',
        },
        {
          ...
          protein: 28,
          description:
            'Long breaded chicken sandwich with lettuce and mayo.',
        ...
        {
          name: 'Spicy Royal Crispy Chicken Sandwich',
          calories: 760,
          protein: 31,
          description: 'Spicy crispy chicken filet sandwich.',
          customization: 'Higher calorie than the regular crispy chicken.',
          tags: ['chicken', 'sandwich', 'spicy'],
          source: 'Burger King nutrition data / published nutrition references',
        },
        {
          ...
          calories: 440,
          protein: 14,
          description: 'Smaller breaded chicken sandwich.',
          customization: 'Ask for no mayo to reduce calories.',
          tags: ['chicken', 'sandwich'],
          source: 'Burger King nutrition data / published nutrition references',
        },
        ...
        },
        {
          ...
          calories: 190,
          protein: 10,
          description: 'Four-piece chicken nuggets.',
          customization: 'Good small side/snack. Watch sauces.',
          tags: ['chicken', 'nuggets', 'lower calorie'],
          source: 'Burger King nutrition data / published nutrition references',
        },
        {
  ...
  
    {
      ...
      items: [
        ...
        },
        {
          ...
          protein: 8,
          description:
            'Classic crunchy taco with seasoned beef, lettuce, and cheese.',
        ...
        },
        {
          ...
          protein: 9,
          description:
            'Classic soft taco with seasoned beef, lettuce, and cheese.',
        ...
        },
        {
          ...
          protein: 13,
          description:
            'Bean burrito with beans, cheese, red sauce, and onions.',
          customization:
            'Filling vegetarian option, but not super high protein.',
        ...
        },
        {
          ...
          protein: 16,
          description:
            'Beef burrito with beans, red sauce, lettuce, cheese, tomatoes, onions, and sour cream.',
          customization: 'Order fresco style to lower calories.',
          tags: ['burrito', 'beef', 'filling'],
          source: 'Taco Bell official nutrition information',
        },
        {
          name: 'Chicken Burrito Supreme Fresco Style',
          calories: 370,
          protein: 19,
          description: 'Chicken Burrito Supreme modified fresco style.',
          customization: 'Fresco swaps dairy/sauces for tomatoes.',
          tags: ['burrito', 'chicken', 'fresco'],
          source: 'Taco Bell official nutrition information',
        },
        {
          ...
          protein: 26,
          description:
            'Chicken bowl with rice, black beans, lettuce, pico, cheese, guacamole, and avocado ranch.',
        ...
        },
        {
          ...
          protein: 12,
          description:
            'Vegetarian bowl with rice, beans, lettuce, pico, cheese, guacamole, and sauce.',
          customization: 'Not high protein, but useful vegetarian option.',
          tags: ['vegetarian', 'bowl', 'has rice', 'has cheese'],
          source: 'Taco Bell official nutrition information',
        },
        {
          ...
          protein: 27,
          description:
            'Chicken quesadilla with cheese and creamy jalapeño sauce.',
          customization: 'Ask for light sauce if possible.',
        ...
        },
        {
          ...
          protein: 27,
          description:
            'Steak quesadilla with cheese and creamy jalapeño sauce.',
          customization: 'Ask for light sauce if possible.',
        ...
        },
        {
          ...
          protein: 16,
          description:
            'Crunchwrap with beef, nacho cheese, tostada shell, sour cream, lettuce, and tomato.',
          customization:
            'Not the best protein-per-calorie item, but useful for comparison.',
          tags: ['beef', 'crunchwrap', 'filling'],
          source: 'Taco Bell official nutrition information',
        },
        {
          name: 'Chicken Crunchwrap Supreme',
          calories: 510,
          protein: 19,
          description: 'Crunchwrap-style item with chicken.',
          customization:
            'Ask for light sour cream or fresco style if available.',
          tags: ['chicken', 'crunchwrap'],
          source: 'Taco Bell official nutrition information',
        },
        {
          ...
          protein: 20,
          description:
            'Seasoned beef, cheese, spicy ranch, lettuce, and shell wrapped in flatbread.',
          customization:
            'Higher calorie for the protein, but not the worst option.',
          tags: ['beef', 'filling'],
          source: 'Taco Bell official nutrition information',
        },
        {
          ...
          protein: 20,
          description:
            'Layered pizza-style Taco Bell item with seasoned beef, beans, cheese, and sauce.',
          customization: 'Moderate protein, higher calorie.',
          tags: ['beef', 'pizza', 'has cheese'],
          source: 'Taco Bell official nutrition information',
        },
        {
          ...
          protein: 17,
          description:
            'Nachos with beef, beans, nacho cheese, tomatoes, and sour cream.',
          customization: 'High calorie for the protein. Better shared.',
          tags: ['beef', 'nachos', 'high calorie'],
          source: 'Taco Bell official nutrition information',
        },
        {
          ...
          protein: 9,
          description:
            'Vegetarian burrito with beans, rice, cheese, and sauce.',
          customization: 'Budget-friendly but lower protein.',
          tags: ['vegetarian', 'burrito', 'has rice', 'has cheese'],
          source: 'Taco Bell official nutrition information',
        },
        {
          ...
          calories: 520,
          protein: 13,
          description: 'Vegetarian Crunchwrap with black beans instead of beef.',
          customization: 'Vegetarian, but not especially high protein.',
          tags: ['vegetarian', 'crunchwrap'],
          source: 'Taco Bell official nutrition information',
        },
        {
          name: '3 Doritos Locos Tacos',
          calories: 510,
          protein: 24,
          description: 'Three Doritos Locos Tacos.',
          customization:
            'Decent protein if you want tacos, but sodium/fat can climb.',
          tags: ['taco', 'beef', 'filling'],
          source: 'Taco Bell official nutrition information',
        },
      ],
    },
      ...
      items: [
        {
          ...
          protein: 13,
          description:
            'Small hamburger with beef patty, bun, pickles, onion, ketchup, and mustard.',
          customization: 'Simple lower-calorie burger option.',
          tags: ['burger', 'lower calorie'],
        ...
        },
        {
          ...
          customization:
            'Solid protein for the calories compared with larger burgers.',
          tags: ['burger', 'has cheese', 'high protein'],
          source: 'Wendy’s official nutrition information',
        },
        {
        ...
        },
        {
          ...
          protein: 28,
          description:
            'Breaded chicken filet sandwich with lettuce, tomato, and mayo.',
        ...
        },
        {
          ...
          protein: 29,
          description:
            'Salad with chicken, apples, pecans, cheese, and dressing.',
          customization:
            'Use less dressing and be mindful of pecans if allergic.',
        ...
        },
        {
          ...
          protein: 37,
          description:
            'Chicken Cobb-style salad with egg, cheese, bacon, and dressing.',
  ...
  
    {
      ...
      items: [
        ...
        },
        {
          ...
          customization:
            'Creamier and more calorie-dense than broth-based soups.',
        ...
        },
        {
          ...
          protein: 42,
          description:
            'Chicken Cobb-style salad with egg, avocado, and Green Goddess dressing.',
        ...
        },
        {
          ...
          protein: 32,
          description:
            'Chicken salad with apple chips, cheese, greens, and vinaigrette.',
          customization: 'Use dressing lightly.',
          tags: ['salad', 'chicken', 'has cheese'],
          source: 'Panera official nutrition guide',
        },
  ...
  
    {
      ...
      items: [
        ...
        },
        {
          ...
          customization:
            'Moderate calories, but less protein than egg options.',
        ...
        },
        {
          ...
          protein: 23,
          description:
            'Protein box with eggs, cheese, fruit, and bread/crackers.',
  ...
  
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Plain bagel.',
          customization:
            'Low protein for the calories unless paired with eggs.',
          tags: ['bakery'],
          source: 'Dunkin’ official nutrition information',
        },
        {
  ...
  
    {
      ...
      items: [
        ...
        },
        {
          ...
          protein: 29,
          description:
            'Pork carnitas portion from fajitas, listed without tortillas and toppings.',
          customization:
        ...
        },
        {
          ...
          customization:
            'Filling option without going into burger-and-fries territory.',
          tags: ['chili', 'filling'],
          source: 'Chili’s official nutrition PDF',
        },
        {
        ...
        },
        {
          ...
          customization:
            'Good lighter chicken option. Watch sides and sugary drinks.',
        ...
        },
        {
          ...
          protein: 51,
          description:
            'Margarita grilled chicken from Chili’s Lighter Choices.',
          customization:
        ...
        },
        {
          ...
          customization:
            'Moderate calories compared with full-size quesadillas.',
        ...
        },
        {
          ...
          customization:
            'High protein but calorie-dense. Use higher calorie slider settings.',
          tags: ['chicken', 'bowl', 'has rice', 'high protein'],
          source: 'Chili’s official nutrition PDF',
        },
        {
          ...
          customization:
            'High protein, high sodium/calorie. Best with a higher calorie slider.',
        ...
        },
        {
          ...
          customization:
            'Fried and calorie-dense; use higher calorie slider settings.',
  ...
  
    {
      ...
      items: [
        ...
        },
        {
          ...
          customization:
            'Good lower-calorie protein option if you eat tuna.',
        ...
        },
        {
          ...
          protein: 81,
          description:
            'Tuscan chicken from the SkinnyLicious/specialties section.',
        ...
        },
        {
          ...
          customization:
            'Protein-heavy, but still over 1,000 calories.',
        ...
        },
        {
          ...
          customization:
            'High protein, but calorie-heavy for a salad.',
          tags: ['chicken', 'salad', 'high protein'],
          source: 'The Cheesecake Factory official nutritional guide',
        },
        {
          ...
          customization:
            'High protein but meant to share; calories are for the listed serving.',
        ...
        },
        {
          ...
          customization:
            'High calorie. Consider splitting or skipping sides.',
        ...
        },
        {
          ...
          customization:
            'Very high protein, but over 1,000 calories.',
        ...
        },
        {
          ...
          customization:
            'Very high protein but calorie-heavy.',
          tags: ['chicken', 'highest protein', 'high calorie'],
          source: 'The Cheesecake Factory official nutritional guide',
        },
        {
        ...
        },
        {
          ...
          customization:
            'Good protein, high calorie. Consider half portion.',
